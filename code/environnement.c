...
resultat_deplacement avancer_envt(Environnement *envt) {
  ...
  envt->e = transition(envt->e,A); 
  envt->e2 = transition_def(envt->e2,A); 
...
void gauche_envt(Environnement *envt) { 
  envt->e = transition(envt->e,G);
  envt->e2 = transition_def(envt->e2,G);

  tourner_a_gauche(&(envt->r)); }

/* Tourner le robot à droite */
void droite_envt(Environnement *envt) { 
  envt->e = transition(envt->e,D); 
  envt->e2 = transition_def(envt->e2,D); 
...
int mesure_envt(Environnement *envt, int d) {
  ...
  envt->e = transition(envt->e,M);
  envt->e2 = transition_def(envt->e2,M);
